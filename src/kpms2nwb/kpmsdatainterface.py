...
from neuroconv.utils import FolderPathType, ArrayType
from pynwb import NWBFile
import h5py

from .utils import write_subject_to_nwb, get_video_timestamps



class KeypointMoseqSubjectDataInterface(BaseDataInterface):
    ...
    def metadata_from_config(**config):
        ...
        for `KeypointMoseqSubjectDataInterface`.
        ...
        metadata : dict
            ...
            to pass to `KeypointMoseqSubjectDataInterface` or an
